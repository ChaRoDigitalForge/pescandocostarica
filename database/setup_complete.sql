-- ============================================
-- PESCANDO COSTA RICA - SETUP COMPLETO
-- Script completo para crear la base de datos
-- y poblarla con datos de prueba
-- ============================================
--
-- INSTRUCCIONES:
-- 1. Crear la base de datos: CREATE DATABASE pescando_costarica;
-- 2. Conectarse: \c pescando_costarica
-- 3. Ejecutar este script: \i setup_complete.sql
--
-- O desde la terminal:
-- psql -U postgres -d pescando_costarica -f setup_complete.sql
-- ============================================

\echo '============================================'
\echo 'PESCANDO COSTA RICA - Iniciando Setup'
\echo '============================================'
...
-- Función para actualizar estadísticas de tours
...
-- Función para generar número de booking
...
BEGIN
    ...
    (capitan_juan_id, 2, 4, 'Pesca Deportiva en Alta Mar', 'pesca-deportiva-alta-mar-quepos', 'Experimenta la emoción de pescar marlín azul y pez vela en las aguas cristalinas del Pacífico. Tour completo con todo el equipo incluido.', 'Pesca de marlín y pez vela en Quepos', 'altaMar', 8, '1 Día', 6, 850.00, 950.00, 'active', true, 4, '/tour-detail-02.webp', ARRAY['/tour-detail-02.webp', '/tour-detail-03.webp', '/tour-detail-05.webp'], 5, 12),
    (capitan_juan_id, 2, 6, 'Pesca en Río y Manglar', 'pesca-rio-manglar-sierpe', 'Explora los manglares de Sierpe en una aventura única. Pesca róbalo, sábalo y otras especies.', 'Aventura en río y manglar de Sierpe', 'rio', 4, '4 Horas', 4, 450.00, NULL, 'active', true, 2, '/tour-detail-03.webp', ARRAY['/tour-detail-03.webp'], 5, 8),
    (capitan_juan_id, 2, 5, 'Pesca de Marlín y Pez Vela', 'pesca-marlin-pez-vela-golfito', 'Golfito es conocido mundialmente por la pesca de marlín. Únete a esta expedición de día completo.', 'Expedición de marlín en Golfito', 'altaMar', 8, '8 Horas', 5, 950.00, 1100.00, 'active', true, 5, '/tour-detail-02.webp', ARRAY['/tour-detail-02.webp'], 5, 18);
    ...
    (capitan_maria_id, 1, 1, 'Pesca Costera en Tamarindo', 'pesca-costera-tamarindo', 'Pesca costera relajante para toda la familia. Ideal para principiantes.', 'Pesca familiar en Tamarindo', 'costera', 6, '6 Horas', 5, 600.00, 'active', false, 2, '/tour-detail-05.webp', 5, 15),
    (capitan_maria_id, 1, 2, 'Tour de Pesca Completo en Flamingo', 'tour-pesca-completo-flamingo', 'Dos días de pesca intensiva con alojamiento incluido.', 'Tour de 2 días en Flamingo', 'altaMar', 16, '2 Días', 6, 1200.00, 'active', true, 4, '/tour-detail-10.webp', 5, 20),
    (capitan_maria_id, 1, 3, 'Pesca al Atardecer en Playa del Coco', 'pesca-atardecer-coco', 'Disfruta de una tarde de pesca mientras contemplas el atardecer.', 'Pesca con atardecer incluido', 'costera', 5, '5 Horas', 4, 550.00, 'active', false, 1, '/tour-detail-05.webp', 5, 14);

    -- Tours Limón
    INSERT INTO tours (capitan_id, provincia_id, location_id, title, slug, description, short_description, fishing_type, duration_hours, duration_display, capacity, price, status, is_featured, difficulty_level, main_image_url, average_rating, total_reviews) VALUES
    (capitan_pedro_id, 3, 7, 'Pesca en el Caribe - Puerto Viejo', 'pesca-caribe-puerto-viejo', 'Experiencia única de pesca en el Caribe costarricense.', 'Pesca caribeña en Puerto Viejo', 'costera', 6, '6 Horas', 4, 480.00, 'active', false, 2, '/tour-detail-03.webp', 5, 11),
    (capitan_pedro_id, 3, 8, 'Aventura de Pesca en Tortuguero', 'aventura-pesca-tortuguero', 'Navega por los canales de Tortuguero mientras pescas.', 'Pesca en canales de Tortuguero', 'rio', 8, '1 Día', 5, 720.00, 'active', true, 3, '/tour-detail-02.webp', 5, 16),
    (capitan_pedro_id, 3, 7, 'Pesca en Canales y Ríos - Cahuita', 'pesca-canales-rios-cahuita', 'Media jornada de pesca en los ríos cercanos a Cahuita.', 'Pesca familiar en Cahuita', 'rio', 4, '4 Horas', 3, 380.00, 'active', false, 1, '/tour-detail-03.webp', 5, 9);
END $$;

-- Promociones
INSERT INTO promociones (code, name, description, promocion_type, discount_percentage, discount_amount, valid_from, valid_until, usage_limit, is_active) VALUES
('WELCOME25', 'Bienvenida 25%', 'Descuento de bienvenida para nuevos clientes', 'percentage', 25.00, NULL, NOW(), NOW() + INTERVAL '30 days', 100, true),
('SUMMER2025', 'Verano 2025', 'Promoción especial de verano', 'percentage', 15.00, NULL, '2025-06-01', '2025-08-31', 500, true),
('EARLYBIRD', 'Madrugador', 'Reserva con 30 días de anticipación', 'percentage', 20.00, NULL, NOW(), NOW() + INTERVAL '90 days', 200, true),
('FAMILY50', 'Descuento Familiar', '$50 de descuento en tours familiares', 'fixed_amount', NULL, 50.00, NOW(), NOW() + INTERVAL '60 days', 150, true);

-- Disponibilidad de tours (próximos 30 días)
DO $$
DECLARE
    tour_record RECORD;
    date_cursor DATE;
...
\echo '============================================'
\echo 'Base de datos: pescando_costarica'
\echo 'Tablas creadas: 21'
\echo 'Usuarios de prueba: 7 (1 admin, 3 capitanes, 3 clientes)'
\echo 'Tours de prueba: 9'
\echo 'Provincias: 7'
\echo 'Promociones: 4'
\echo '============================================'
